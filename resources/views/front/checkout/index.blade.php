        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <form method="post" id="payment-form" action="{{route('checkout')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name_card" name="name_card" placeholder="Name on card">
                    </div>
            ...
            <div class="col-md-5">
                ...
                <table class="table your-order-table">
                    ...
                    <tr>
                        <td><img src="{{url('uploads'. '/' . $item->model->product_image)}}" alt="" style="width: 4em"></td>
                        <td>
                            <strong>{{$item->model->product_name}}</strong><br>
                           {{$item->model->product_description}}<br>
...
@section('script')
    ...
    <script>
        ...
        var stripe = Stripe('pk_test_H3P5CMB5ZciSw6281xp33Ys700xz1TJNKn');
